...
if __name__ == "__main__":
    ...
    text_pairs = load_text_pairs("reports/output.en-si")
    ...
    save_split_data(train_pairs, "reports/train.en-si")
    save_split_data(val_pairs, "reports/val.en-si")
    save_split_data(test_pairs, "reports/test.en-si")
